                        ...
                        <!-- Formulaire -->
                            <div class="grid gap-6 mb-6 md:grid-cols-2 p-2 m-2">
                                ...
                                <div>
                                    ...
                                    <input type="number" id="matr" name="matr" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" >
                                </div>
                                {{-- poste prévu --}}
                                <div>
                                    <label for="joP" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Poste prévu</label>
                                    <input type="text" id="jobP" name="jobP" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" >
                                </div>  
                                {{-- poste réalisé --}}
                                <div>
                                    <label for="jobR" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Poste réalisé</label>
                                    <input type="text" id="jobR" name="jobR" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder=" " >
                                </div>
                                {{-- observation --}}
                                <div>
                                    <label for="observ" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Observation</label>
                                    <input type="text" id="observ" name="observ" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder=" " >
                                </div>
                                {{-- equipe --}}
                                <div>
                                    <label for="equipe" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Équipe</label>
                                    <input type="text" id="equipe" name="equipe" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder=" " >
                                </div>
                                {{-- image --}}
